...
After adding your svg icon in `icon-svg`, modifying `plasma-icons.js`, and updating `README.md.`
Open pull requests on the **[dev branch](https://github.com/PlasmaPod/plasma-icons/pulls)**.
